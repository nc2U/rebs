...
class Project(models.Model):
    ...
    local_zipcode = models.CharField('우편번호', max_length=5, blank=True, default='')
    local_address1 = models.CharField('대표부지 주소', max_length=35, blank=True, default='')
    local_address2 = models.CharField('상세주소', max_length=20, blank=True, default='')
    local_address3 = models.CharField('참고항목', max_length=20, blank=True, default='')
...
class ProjectIncBudget(models.Model):
    ...
    account_d2 = models.ForeignKey('rebs.ProjectAccountD2', on_delete=models.PROTECT, verbose_name='대분류')
