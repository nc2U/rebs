...
class Project(models.Model):
    ...
    local_address1 = models.CharField('대표부지 주소', max_length=35, blank=True, null=True)
    local_address2 = models.CharField('상세주소', max_length=20, blank=True, null=True)
    local_address3 = models.CharField('참고항목', max_length=20, blank=True, null=True)
