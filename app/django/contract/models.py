...
class Contractor(models.Model):
    ...
    STATUS_CHOICES = (('1', '청약'), ('2', '계약'), ('3', '해지 신청'), ('4', '해지 완료'))
...
class ContractorRelease(models.Model):
    ...
    refund_account_number = models.CharField('환불계좌(번호)', max_length=25, blank=True)
    refund_account_depositor = models.CharField('환불계좌(예금주)', max_length=20, blank=True)
