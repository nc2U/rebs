...
router.register(r'all-departs', company.AllDepartsViewSet)
router.register(r'rank', company.JobRankViewSet)
router.register(r'all-ranks', company.AllRanksViewSet)
