...
<template>
  ...
  <!--      </CCol>-->
  <!--      <CCol md="2">-->
  <!--        &lt;!&ndash;        <v-checkbox-btn v-model="form.is_notice" label="공지글" />&ndash;&gt;-->
  <!--      </CCol>-->
  <!--    </CRow>-->
  ...
  <!--      &lt;!&ndash;      <CFormLabel for="inputPassword" class="col-sm-2 col-form-label"> 문서 발행일자</CFormLabel>&ndash;&gt;-->
  <!--      &lt;!&ndash;      <CCol md="3">&ndash;&gt;-->
  <!--      &lt;!&ndash;        <DatePicker v-model="form.execution_date" placeholder="문서 발행일자" />&ndash;&gt;-->
  <!--      &lt;!&ndash;      </CCol>&ndash;&gt;-->
  <!--    </CRow>-->
