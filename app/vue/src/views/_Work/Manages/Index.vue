...
import ProjectList from '@/views/_Work/Manages/_components/ProjectList.vue'
import ProjectForm from '@/views/_Work/Manages/_components/ProjectForm.vue'
import Overview from '@/views/_Work/Manages/_components/Overview/Index.vue'
import Activity from '@/views/_Work/Manages/_components/Activity/Index.vue'
import Roadmap from '@/views/_Work/Manages/_components/Roadmap/Index.vue'
import Issues from '@/views/_Work/Manages/_components/Issues/Index.vue'
import SpentTime from '@/views/_Work/Manages/_components/SpentTime/Index.vue'
import Gantt from '@/views/_Work/Manages/_components/Gantt/Index.vue'
import Calendar from '@/views/_Work/Manages/_components/Calendar/Index.vue'
import News from '@/views/_Work/Manages/_components/News/Index.vue'
import Documents from '@/views/_Work/Manages/_components/Documents/Index.vue'
import Wiki from '@/views/_Work/Manages/_components/Wiki/Index.vue'
import Forums from '@/views/_Work/Manages/_components/Forums/Index.vue'
import Files from '@/views/_Work/Manages/_components/Files/Index.vue'
import Repository from '@/views/_Work/Manages/_components/Repository/Index.vue'
import Settings from '@/views/_Work/Manages/_components/Settings/Index.vue'
