...
const bankFees = ref([14, 53]) // 은행수수료 d2(id), d3(id)
const transferD3 = ref([65, 66]) // 대체 출금(id), 입금(id)
const cancelD3 = ref([67, 68]) // 취소 출금(id), 입금(id)

provide('transfers', [17, 65]) // 대체 d2(id), d3(id)
provide('cancels', [18, 67]) // 취소 d2(id), d3(id)
