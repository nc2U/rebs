...
urlpatterns = [
    ...
    path('account-sort/<int:pk>/', AccountSortDetail.as_view(), name=AccountSortDetail.name),
    ...
    path('unit/', HouseUnitList.as_view(), name=HouseUnitList.name),
    path('unit/<int:pk>/', HouseUnitDetail.as_view(), name=HouseUnitDetail.name),
